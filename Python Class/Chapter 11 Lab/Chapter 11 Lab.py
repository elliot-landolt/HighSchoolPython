...
soccerball = pygame.image.load("ball_soccer2.png")

# sound
background_music = pygame.mixer.Sound("Background Music.wav")
background_music.play()
soccer_kick = pygame.mixer.Sound("Ballkick.wav")
soccer_roll = pygame.mixer.Sound("Ballroll.wav")
